...
export default registerAs('gateway_external_api', () => ({
    ...
    components_schema_backend_endpoint: "/ext/core_component/export/standalone",
    ...
    bie_packages_bies_backend_endpoint: '/ext/bie-packages/${packageName}/${packageVersionId}/bies',
